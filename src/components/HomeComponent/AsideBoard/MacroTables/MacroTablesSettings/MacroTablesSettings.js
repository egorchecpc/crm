...
const MacroTablesSettings = ({ isOpen, onClose, onSave, initialData }) => {
    ...
    useEffect(() => {
        if (initialData) {
            setFormData({
                ...
                worst: { value: initialData.worst.value, chance: initialData.worst.change },
                normal: { value: initialData.normal.value, chance: initialData.normal.change },
                best: { value: initialData.best.value, chance: initialData.best.change },
            });
        }
    }, [initialData]);
            ...
            <div className={s.modalContent} ref={modalContentRef}>
                ...
                <form className={s.form}>
                    <label className={s.label}>
                        ...
                        <select className={s.select} name="type" value={formData.type} onChange={handleInputChange} disabled={!!initialData}>
